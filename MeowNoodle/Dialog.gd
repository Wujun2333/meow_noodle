...
var script1 = [
	...
	"Yeah, that’s him.",
	"What did he say?",
	"Don’t worry about it Hannah. Why are you here?",
	...
	"Haha, yes, I’m glad that’s over now.",
	...
	"Okay… Hannah, there’s something you need to know. But don’t tell your mother now, she needs to recuperate in peace.",
	"I won’t.",
	"We… we might lose our store.",
	"What?! ",
	"Yes. The landlord asked me to pay for rent from the past two months. I’m afraid we don’t have that much savings now, and not even enough to hire new workers after we spend so much on...",
	"…Yes, dad, I know, on mom’s hospitalization. Dad, you know, I can help too. ",
	"Hannah… I will work my hardest to keep you guys safe and warm. You don’t need to do this.",
	"But I want to. You and mom always worked so hard just so I could choose for my own life. Now It’s time for me to take responsibility and help out our family. I've made my decision.",
	"Hannah. You’ve grown up. We will do this together.",
...
func _on_TextureButton_pressed():
	...
	print($Dialog/AnimationPlayer.playback_speed)
